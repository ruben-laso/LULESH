...
public:
    ...
    void
    AllocateNodePersistent(Int_t numNode) // Node-centered
    {
    ...
    void
    AllocateElemPersistent(Int_t numElem) // Elem-centered
    {
    ...
    void
    AllocateGradients(Int_t numElem, Int_t allElem)
    {
        // Position gradients
    ...
    //
    Index_t&
    regElemSize(Index_t idx)
    {
        return m_regElemSize[idx];
    }
    Index_t&
    regNumList(Index_t idx)
    {
    ...
    Index_t&
    regElemlist(Int_t r, Index_t idx)
    {
        return m_regElemlist[r][idx];
    }

    Index_t*
    nodelist(Index_t idx)
    {
    ...
    Real_t&
    delv_eta(Index_t idx)
    {
        return m_delv_eta[idx];
    }
    Real_t&
    delv_zeta(Index_t idx)
    {
    ...
    Real_t&
    delx_eta(Index_t idx)
    {
        return m_delx_eta[idx];
    }
    Real_t&
    delx_zeta(Index_t idx)
    {
    ...
    // Element mass
    Real_t&
    elemMass(Index_t idx)
    {
        return m_elemMass[idx];
    }

    Index_t
    nodeElemCount(Index_t idx)
    {
        return m_nodeElemStart[idx + 1] - m_nodeElemStart[idx];
    }

    Index_t*
    nodeElemCornerList(Index_t idx)
    {
    ...
    vnew_end()
    {
        return m_vnew.data() + m_vnew.size();
    }
    Real_t*
    nodalMass_begin()
    {
        return m_nodalMass.data();
    }
    ...
    Real_t
    monoq_max_slope() const
    {
        return m_monoq_max_slope;
    }
    Real_t
    monoq_limiter_mult() const
    {
...
public:
    ...
    friend self
    operator+(self const& i, difference_type n)
    {
        return self(i.value + n);
    }
    friend self
    operator+(difference_type n, self const& i)
    {
        return self(i.value + n);
    }
    friend difference_type
    operator-(self const& x, self const& y)
    {
